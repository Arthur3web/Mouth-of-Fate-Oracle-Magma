...
function startApp() {
  ...
  const predictions = [
    ...
    "Все придёт в свое время.\nСудьба подскажет.",
    "Лепесток летит к воде.\nВсё идёт как надо.",
    "Пламя колеблется.\nСейчас не время.",
    "Ветер дует в обратную сторону.\nПока не время.",
    "Тени расходятся, не встретившись с Вами.",
    "След обрывается у старого камня.\nНужно подождать.",
    "Луна убывает.\nВремя подождать.",
    "Пламя мерцает между двух углей.\nВыбор за Вами.",
    "Ветер затих.\nЖдите следующего знака.",
    "Тени смешались.\nСейчас не разобраться.",
    "Туман стелется по тропе.\nЖдите, когда рассеется.",
    "Река течёт спокойно.\nДоверьтесь времени.",
    "Длинный путь начинается с первого шага.",
    "Путь открыт перед Вами.\nДействуйте.",
    "Терпение принесёт неожиданный дар.",
    "Даже капля способна изменить камень.",
    "Судьба благосклонна к чистому сердцу.",
    "Огонь советует рискнуть.\nДействуйте.",
    "Ваша энергия способна изменить ход событий.",
    "Решение близко.\nНе бойтесь перемен.",
    "Присмотритесь.\nСудьба говорит символами.",
    "Ветер переменится.\nПока не время."
  ];
